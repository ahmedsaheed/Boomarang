...
<section class="facilities">
    ...
    <div class="row">
        <div class="facilities-col">
            ...
            <a href="classrooms.php"><h3 style="color:black;">Classrooms</h3></a>
            <p>In ornare quam viverra orci sagittis eu volutpat.</p>
        </div>
        <div class="facilities-col">
            <a href="garden.php"><img src="images/facility2.jpg"></a>
            <a href="garden.php"><h3 style="color:black;">Garden</h3></a>
            <p>In ornare quam viverra orci sagittis eu volutpat.</p>
        </div>
        <div class="facilities-col">
            <a href="kitchen.php"><img src="images/facility3.jpg"></a>
            <a href="kitchen.php"><h3 style="color:black;">Kitchen</h3></a>
            <p>In ornare quam viverra orci sagittis eu volutpat.</p>
        </div>
    </div>
</section>
